...
VALUES ('SP_INGEST_FLIGHTS_FROM_STAGE', 'SUCCESS', (SELECT COUNT(*)
                                                    FROM AIRLINE_DWH.RAW.RAW_FLIGHTS
                                                    WHERE LOAD_TIMESTAMP >= DATEADD(minute, -1, CURRENT_TIMESTAMP())), 'Loaded file ' || :FILE_NAME);
